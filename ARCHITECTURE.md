...
## Slide export (optional)

If you want SVGs for slides, copy any Mermaid block into a `.mmd` file and run:

```bash
npx @mermaid-js/mermaid-cli -i build/diagram.mmd -o build/diagram.svg
```
